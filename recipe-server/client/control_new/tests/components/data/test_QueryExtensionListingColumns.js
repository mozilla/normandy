...
import TestComponent from 'control_new/components/data/QueryExtensionListingColumns';
...
describe('<QueryExtensionListingColumns>', () => {
  ...
  it('should call loadExtensionListingColumns on mount', () => {
    let called = false;
    const wrapper = shallow(<QueryExtensionListingColumns loadExtensionListingColumns={()=>{called = true;}} />);
