...
export const EXPERIMENTS_RECEIVE = 'EXPERIMENTS_RECEIVE';
export const EXPERIMENT_ACCEPTED = 'EXPERIMENT_ACCEPTED';
export const EXPERIMENT_ALREADY_ACCEPTED = 'EXPERIMENT_ALREADY_ACCEPTED';
export const EXPERIMENT_SELECT_REJECTED = 'EXPERIMENT_SELECT_REJECTED';
export const EXPERIMENT_REJECTED = 'EXPERIMENT_REJECTED';
