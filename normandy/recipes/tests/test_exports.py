...
class TestRemoteSettings(object):
    ...
    def test_publish_puts_record_and_approves(self, settings, mock_kinto_request):
        ...
        payload = json.dumps({"data": recipe_data})
    ...
    def test_unpublish_deletes_record_and_approves(self, settings, mock_kinto_request):
