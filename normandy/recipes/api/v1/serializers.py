...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    approved_revision_id = serializers.CharField(source='approved_revision.id', default=None,
                                                 read_only=True)
        ...
        if action is None:
            if not self.instance:
                raise serializers.ValidationError({
                    'action': serializers.PrimaryKeyRelatedField.default_error_messages['required']
                })
