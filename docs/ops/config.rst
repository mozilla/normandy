...
..envvar:: DJANGO_AUTOGRAPH_URL
    ...
    The URL where an Autograph_ server can be reached. If left blank, action
...
..envvar:: ACTION_SIGNATURE_MAX_AGE

    :default: ``604800`` (1 week)

    Actions with signature ages older than this are considered out of date and
    will be re-signed. The keys used by Autograph to sign Actions are generally
