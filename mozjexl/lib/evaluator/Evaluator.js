 ...
 * @constructor
 */
const Evaluator = function (grammar, transforms, context, relativeContext) {
...
Evaluator.prototype.eval = function (ast) {
  const self = this;
  return Promise.resolve().then(() => handlers[ast.type].call(self, ast));
};
...
Evaluator.prototype.evalMap = function (map) {
  let keys = Object.keys(map),
    result = {};
  const asts = keys.map(function (key) {
